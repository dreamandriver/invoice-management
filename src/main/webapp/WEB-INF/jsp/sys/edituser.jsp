...
<%@ include file="/WEB-INF/jsp/base/common_js.jsp"%>
	...
	function useredit(){
		if($.formValidator.pageIsValid()){
			jquerySubByFId('useraddform',useredit_callback,null,"json");
		}

	}
	function useredit_callback(data){
...
<BODY>
<form id="useraddform" name="useraddform" action="${baseurl}/sys/user/update" method="post">
<input type="hidden" name="user.serialno" value="${user.serialno}" />
					...
					<TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4
						...
						<TBODY>
							...
							<TR>
								...
								<TD class=category width="35%">
								<div>
									<input type="text" id="user_password" name="user.password" />
								</div>
							...
							<tr>
							  <td colspan=4 align=center class=category>
								<a id="submitbtn" href="#" onclick="useredit()">提交</a>
